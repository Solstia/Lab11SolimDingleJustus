...
* Description: Reads data from an binary IO file to the console and into an arraylist, sorts them, and prints them back out to a new file.
...
public class Lab11Prob02 {
	public static void main(String[] args) {
		...
		try (DataOutputStream output = new DataOutputStream(new FileOutputStream("src/people-salary-stored.dat"))) {
